...
import { WelcomeScreen, SplashScreen, LoginScreen, SignUpScreen, VerifyEmailScreen, ForgotPasswordScreen, ResetPasswordScreen, PrivacyPolicyScreen, TermsOfServiceScreen } from '../modules/authentication/screens';
